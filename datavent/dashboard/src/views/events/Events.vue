<template>
  <div class="app-container events-list-container">
        ...
        <el-card :body-style="{ padding: '0px' }">
          ...
          <div class="chart-wrapper">
            <el-tabs v-model="activeName" @tab-click="handleClick">
                ...
                <el-tab-pane label="Tables" name="third">Tables</el-tab-pane>   
                <el-tab-pane label="Businesses" name="fourth">Businesses</el-tab-pane>               
            </el-tabs>
          </div>
        </el-card>
      </el-col>
