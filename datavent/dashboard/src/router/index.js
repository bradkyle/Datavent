...
export const constantRouterMap = [
  ...
  },
  {
    ...
    children: [{
      path: 'index',
      component: _import('people/peopleTable'),
      name: 'people',
      meta: { title: 'People', icon: 'documentation', noCache: true }
    }]
  },
  {
    path: '/businesses',
    ...
    children: [{
      path: 'index',
      component: _import('businesses/Businesses'),
      name: 'businesses',
      meta: { title: 'Businesses', icon: 'documentation', noCache: true }
    }]
  },
  {
    path: '/events',
